...
// The host seam must exist before anything renders or fetches. MODE is a
// build-time constant, so the unused host implementation tree-shakes away.
const isVscode = import.meta.env.MODE === 'vscode';
setHost(isVscode ? createVscodeHost() : webHost);
...
if (!isVscode) registerSW({ immediate: true });
